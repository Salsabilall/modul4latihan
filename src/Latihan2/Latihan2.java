        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    break;
                case 2:
                    org.example.Latihan2 analyzer1 = new org.example.Latihan2(input);
                    int karakter = analyzer1.hitungKarakter();
                    System.out.println("Jumlah karakter: " + karakter);
                    break;
                case 3:
                    org.example.Latihan2 analyzer2 = new org.example.Latihan2(input);
                    int kata = analyzer2.hitungKata();
                    System.out.println("Jumlah kata: " + kata);
                    break;
                case 4:
                    org.example.Latihan2 analyzer3 = new org.example.Latihan2(input);
